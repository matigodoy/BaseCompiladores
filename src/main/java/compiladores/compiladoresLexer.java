...
public class compiladoresLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "PARIZQ", "PARDER", "DIGITO", "WS", "COMILLA", "COMSIMPLE", "LETRA", 
			"PUNTOCOMA", "COMA", "LLAVEIZQ", "LLAVEDER", "CORCHETEIZQ", "CORCHETEDER", 
			"IGUAL", "MAYOR", "MENOR", "MAYORIGUAL", "MENORIGUAL", "DIFERENTE", "IGUALDAD", 
			"AND", "OR", "NOT", "INCREMENTO", "DECREMENTO", "SUMA", "RESTA", "MULTIPLICACION", 
			"DIVISION", "MODULO", "IF", "ELSE", "WHILE", "FOR", "RETURN", "TDATO", 
			"PRINT", "OPERADOR", "LOGICO", "NUMERO", "ID"
		};
	}
